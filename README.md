<div align="center">
  <br />
    <a href="https://github.com/Asirwad/Appointment-Scheduling-App-NextJS" target="_blank">
...
```bash
git clone https://github.com/Asirwad/Appointment-Scheduling-App-NextJS.git
cd Appointment-Scheduling-App-NextJS
```
